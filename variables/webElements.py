...
txtPhoneNumberNewUser = "xpath://input[@name='phoneNumber']"
txtJobTitleNewUser = "xpath://input[@name='jobTitle']"
cboRoleNewUser = "//*[@id='role']"
chkAllDealerNewUser = "id:includeAllDealer"
btnSaveNewUser = "xpath://button[@type='submit']"
